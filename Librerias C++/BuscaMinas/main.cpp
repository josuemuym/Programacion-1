...
int main()
{
    // Configuración inicial del juego (se puede cambiar desde el menú)
    ...
    // Se usa el PID del proceso como semilla para que las minas sean distintas cada vez
    srand(getpid());
    ...
    do
    {
        ...
        switch (opciones)
        {
            ...
            case 2:
                {
                    // Se crea un juego nuevo cada vez con la configuración actual
                    Juego juegoTemporal(
                        Tablero(configuracionJuego.getfilasTablero(),
