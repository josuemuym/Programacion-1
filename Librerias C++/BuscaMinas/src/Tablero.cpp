...
// Cuenta cuántas minas hay en las celdas vecinas (máximo 8 vecinos)
...
// Imprime la fila de números de columna (encabezado del tablero)
...
// Marca la celda como descubierta. Retorna false si había una mina (el jugador pierde).
