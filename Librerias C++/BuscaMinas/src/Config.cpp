...
// Inicializa la configuración con los valores que se pasen desde el main
Config::Config(int filasTablero, int columnasTablero, int minasTablero,
...
// Muestra un menú donde el jugador puede cambiar cualquier parámetro del juego
void Config::menuConfiguracion()
{
    int opciones, valorIngresado;
    bool repetir = true;
    ...
    do
    {
        ...
        // Muestra los valores actuales junto a cada opción
        ...
        // Solo pide valor si el usuario no eligió salir
        if (opciones != 6)
        {
        ...
        switch (opciones)
        {
            case 1: this->setfilasTablero(valorIngresado);
                    cout << "Filas del Tablero actualizadas" << endl; break;

            case 2: this->setcolumnasTablero(valorIngresado);
                    cout << "Columnas del Tablero actualizadas" << endl; break;

            case 3: this->setminasTablero(valorIngresado);
                    cout << "Minas del Tablero actualizadas" << endl; break;

            case 4: this->setmodoDesarrolladorTablero(valorIngresado);
                    cout << "Modo del Juego actualizado" << endl; break;

            case 5: this->setvidasTablero(valorIngresado);
                    cout << "Vidas del Juego actualizadas" << endl; break;
